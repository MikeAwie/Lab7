...
public class DrawingPanel extends JPanel {
    ...
    private void drawShape(int x, int y) {
        ...
        int radius = rand.nextInt(150); //generate a random number
        int sides = (int) frame.configPanel.sidesField.getValue(); //get the value from UI (in ConfigPanel)
        switch (frame.configPanel.colorCombo.getSelectedIndex()) {
            case 0:
        ...
        switch (frame.configPanel.shapeCombo.getSelectedIndex()) {
            case 0:
